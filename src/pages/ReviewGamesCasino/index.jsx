...
import { ModalReviewCasinoGames } from '../../components/ModalGamesCasino/modalReviewsGamesCasino';

export const ReviewsGamesCasino = () => {
  const { chooseCasinoGames, setTrigger } = GetContext();
